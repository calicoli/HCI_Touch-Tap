...
public class lab0Factors : MonoBehaviour
{


    public enum Lab0Phase
    {
        in_lab0_scene = 0,
        check_connection = 1,
    ...
    public static readonly Dictionary<PublicLabFactors.Lab0_tap_55.Posture, (int firstid, int secondid)[]> 
        comPositions4postures =
        new Dictionary<PublicLabFactors.Lab0_tap_55.Posture, (int firstid, int secondid)[]>
        {
            { PublicLabFactors.Lab0_tap_55.Posture.left1_right1,  comPositions },
            { PublicLabFactors.Lab0_tap_55.Posture.left1_right2,  comPositions },
            { PublicLabFactors.Lab0_tap_55.Posture.right1_right2, comPositions },
            { PublicLabFactors.Lab0_tap_55.Posture.right2_right3, comPositions },
        };
    ...
    public struct BlockCondition
    {
        string prefix;
        int blockid;
        PublicLabFactors.Lab0_tap_55.Posture posture;
        PublicLabFactors.Lab0_tap_55.Orientation orientation;
        PublicLabFactors.Lab0_tap_55.Shape shape;
        float angle;
        ...
        public BlockCondition(int bid, int p, int a, int s, int o)
        {
            ...
            posture = (PublicLabFactors.Lab0_tap_55.Posture)p;
            orientation = (PublicLabFactors.Lab0_tap_55.Orientation)o;
            shape = (PublicLabFactors.Lab0_tap_55.Shape)s;
            angle = PublicLabFactors.Lab0_tap_55.AngleBetweenScreens[(int)a];
        }
        ...
        public PublicLabFactors.Lab0_tap_55.Posture getPosture()
        {
            return posture;
        }
        ...
        public PublicLabFactors.Lab0_tap_55.Shape getShape()
        {
            return shape;
        }

        public PublicLabFactors.Lab0_tap_55.Orientation getOrientation()
        {
            return orientation;
        }
