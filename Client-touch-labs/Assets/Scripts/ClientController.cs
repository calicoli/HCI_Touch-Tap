...
public class ClientController : MonoBehaviour
{
    ...
    {
        GlobalController.Instance.setLabName(messages[1]);
    }
    ...
    public void prepareNewMessage4Server(MessageType msgType)
    {
        ...
        else if(msgType == MessageType.Trial)
        {
            ...
            msgContent = msgType.ToString() + paramSeperators
                       ...
                       + acc.y + paramSeperators
                       + acc.z + paramSeperators;
            switch (GlobalController.Instance.targetLabName)
            {
    ...
    {
        string res;
        string cTrialid = GlobalController.Instance.curLab0Trialid.ToString();
        string cRepeatitionid = GlobalController.Instance.curLab0Repeateid.ToString();
        string cTarget2id = GlobalController.Instance.curLab0Trial.secondid.ToString();
        string cTrialPhase = GlobalController.Instance.curLab0TrialPhase.ToString();
    ...
    {
        string res;
        string cTrialid = GlobalController.Instance.curLab1Trialid.ToString();
        string cRepeatitionid = GlobalController.Instance.curLab1Repeateid.ToString();
        string cTarget2id = GlobalController.Instance.curLab1Trial.secondid.ToString();
